...
#define DC_ELMERS_MEMBER_ENT					DC_ELMERS_BASE_ID + 1
#define DC_ELMERS_MEMBER_INVERT_X				DC_ELMERS_BASE_ID + 2
#define DC_ELMERS_MEMBER_INVERT_Y				DC_ELMERS_BASE_ID + 3
#define DC_ELMERS_MEMBER_INVERT_Z				DC_ELMERS_BASE_ID + 4
#define DC_ELMERS_MEMBER_LEVEL_X				DC_ELMERS_BASE_ID + 5
#define DC_ELMERS_MEMBER_LEVEL_Y				DC_ELMERS_BASE_ID + 6
#define DC_ELMERS_MEMBER_LEVEL_Z				DC_ELMERS_BASE_ID + 7
#define DC_ELMERS_MEMBER_OFFSET_X				DC_ELMERS_BASE_ID + 8
#define DC_ELMERS_MEMBER_OFFSET_Y				DC_ELMERS_BASE_ID + 9
#define DC_ELMERS_MEMBER_OFFSET_Z				DC_ELMERS_BASE_ID + 10
#define DC_ELMERS_MEMBER_PALETTE_MATCH			DC_ELMERS_BASE_ID + 11
#define DC_ELMERS_MEMBER_POSITION_QUANTITY_X	DC_ELMERS_BASE_ID + 12
#define DC_ELMERS_MEMBER_POSITION_QUANTITY_Y	DC_ELMERS_BASE_ID + 13
#define DC_ELMERS_MEMBER_POSITION_QUANTITY_Z	DC_ELMERS_BASE_ID + 14
#define DC_ELMERS_MEMBER_POSITION_STATE_X		DC_ELMERS_BASE_ID + 15
#define DC_ELMERS_MEMBER_POSITION_STATE_Y		DC_ELMERS_BASE_ID + 16
#define DC_ELMERS_MEMBER_POSITION_STATE_Z		DC_ELMERS_BASE_ID + 17
#define DC_ELMERS_MEMBER_TARGET					DC_ELMERS_BASE_ID + 18
#define DC_ELMERS_MEMBER_THE_END				19				// Should always last, with a value one higher than previous key ID.
