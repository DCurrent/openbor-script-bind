...
#define DC_BIND_VAR_KEY_OFFSET_X		DC_BIND_VAR_KEY_BASE_ID + 2
#define DC_BIND_VAR_KEY_OFFSET_Y		DC_BIND_VAR_KEY_BASE_ID + 3
#define DC_BIND_VAR_KEY_OFFSET_Z		DC_BIND_VAR_KEY_BASE_ID + 4
#define DC_BIND_VAR_KEY_POSITIONING_X	DC_BIND_VAR_KEY_BASE_ID + 5
#define DC_BIND_VAR_KEY_POSITIONING_Y	DC_BIND_VAR_KEY_BASE_ID + 6
#define DC_BIND_VAR_KEY_POSITIONING_Z	DC_BIND_VAR_KEY_BASE_ID + 7
#define DC_BIND_VAR_KEY_TARGET			DC_BIND_VAR_KEY_BASE_ID + 8
#define DC_BIND_VAR_KEY_THE_END			9			// Should always last, with a value one higher than previous key ID.
