...
#define DC_BIND_VAR_KEY_POSITIONING_X	DC_BIND_VAR_KEY_BASE_ID + 2
#define DC_BIND_VAR_KEY_POSITIONING_Y	DC_BIND_VAR_KEY_BASE_ID + 3
#define DC_BIND_VAR_KEY_POSITIONING_Z	DC_BIND_VAR_KEY_BASE_ID + 4
...
#define DC_BIND_VAR_KEY_THE_END			9			// Should always last, and one higher than previous key ID.
