...
// -- for a given axis.
#define DC_BIND_MODE_DISABLED	openborconstant("BIND_MODE_NONE")
#define DC_BIND_MODE_LEVEL		openborconstant("BIND_MODE_LEVEL")
#define DC_BIND_MODE_SCREEN		3
#define	DC_BIND_MODE_TARGET		openborconstant("BIND_MODE_TARGET")
...
#define DC_BIND_DEFAULT_LEVEL_X			0
#define DC_BIND_DEFAULT_LEVEL_Y			0
#define DC_BIND_DEFAULT_LEVEL_Z			0
#define DC_BIND_DEFAULT_OFFSET_X		0
#define DC_BIND_DEFAULT_OFFSET_Y		0
#define DC_BIND_DEFAULT_OFFSET_Z		0
#define DC_BIND_DEFAULT_POSITION_STATE_X	DC_BIND_MODE_TARGET
#define DC_BIND_DEFAULT_POSITION_STATE_Y	DC_BIND_MODE_TARGET
#define DC_BIND_DEFAULT_POSITION_STATE_Z	DC_BIND_MODE_TARGET
...
#define DC_BIND_VAR_KEY_LEVEL_X			DC_BIND_VAR_KEY_BASE_ID + 5
#define DC_BIND_VAR_KEY_LEVEL_Y			DC_BIND_VAR_KEY_BASE_ID + 6
#define DC_BIND_VAR_KEY_LEVEL_Z			DC_BIND_VAR_KEY_BASE_ID + 7
#define DC_BIND_VAR_KEY_OFFSET_X		DC_BIND_VAR_KEY_BASE_ID + 8
#define DC_BIND_VAR_KEY_OFFSET_Y		DC_BIND_VAR_KEY_BASE_ID + 9
#define DC_BIND_VAR_KEY_OFFSET_Z		DC_BIND_VAR_KEY_BASE_ID + 10
#define DC_BIND_VAR_KEY_POSITION_STATE_X	DC_BIND_VAR_KEY_BASE_ID + 11
#define DC_BIND_VAR_KEY_POSITION_STATE_Y	DC_BIND_VAR_KEY_BASE_ID + 12
#define DC_BIND_VAR_KEY_POSITION_STATE_Z	DC_BIND_VAR_KEY_BASE_ID + 13
#define DC_BIND_VAR_KEY_TARGET			DC_BIND_VAR_KEY_BASE_ID + 14
#define DC_BIND_VAR_KEY_THE_END			15			// Should always last, with a value one higher than previous key ID.
