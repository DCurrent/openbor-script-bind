...
#define DC_ELMERS_MEMBER_DISABLED				DC_ELMERS_BASE_ID + 6
#define DC_ELMERS_MEMBER_DOUBLE_OFFSET_X		DC_ELMERS_BASE_ID + 7
#define DC_ELMERS_MEMBER_DOUBLE_OFFSET_Y		DC_ELMERS_BASE_ID + 8
#define DC_ELMERS_MEMBER_DOUBLE_OFFSET_Z		DC_ELMERS_BASE_ID + 9
#define DC_ELMERS_MEMBER_ENT					DC_ELMERS_BASE_ID + 10
#define DC_ELMERS_MEMBER_INVERT_X				DC_ELMERS_BASE_ID + 11
#define DC_ELMERS_MEMBER_INVERT_Y				DC_ELMERS_BASE_ID + 12
#define DC_ELMERS_MEMBER_INVERT_Z				DC_ELMERS_BASE_ID + 13
#define DC_ELMERS_MEMBER_LEVEL_X				DC_ELMERS_BASE_ID + 14
#define DC_ELMERS_MEMBER_LEVEL_Y				DC_ELMERS_BASE_ID + 15
#define DC_ELMERS_MEMBER_LEVEL_Z				DC_ELMERS_BASE_ID + 16
#define DC_ELMERS_MEMBER_OFFSET_X				DC_ELMERS_BASE_ID + 17
#define DC_ELMERS_MEMBER_OFFSET_Y				DC_ELMERS_BASE_ID + 18
#define DC_ELMERS_MEMBER_OFFSET_Z				DC_ELMERS_BASE_ID + 19
#define DC_ELMERS_MEMBER_PALETTE_MATCH			DC_ELMERS_BASE_ID + 20
#define DC_ELMERS_MEMBER_POSITION_QUANTITY_X	DC_ELMERS_BASE_ID + 21
#define DC_ELMERS_MEMBER_POSITION_QUANTITY_Y	DC_ELMERS_BASE_ID + 22
#define DC_ELMERS_MEMBER_POSITION_QUANTITY_Z	DC_ELMERS_BASE_ID + 23
#define DC_ELMERS_MEMBER_ANCHOR_X				DC_ELMERS_BASE_ID + 24
#define DC_ELMERS_MEMBER_ANCHOR_Y				DC_ELMERS_BASE_ID + 25
#define DC_ELMERS_MEMBER_ANCHOR_Z				DC_ELMERS_BASE_ID + 26
#define DC_ELMERS_MEMBER_SIZE_FACTOR_HEIGHT		DC_ELMERS_BASE_ID + 27
#define DC_ELMERS_MEMBER_SIZE_FACTOR_WIDTH		DC_ELMERS_BASE_ID + 28
#define DC_ELMERS_MEMBER_TAG					DC_ELMERS_BASE_ID + 29
#define DC_ELMERS_MEMBER_TARGET					DC_ELMERS_BASE_ID + 30
#define DC_ELMERS_MEMBER_THE_END				31				// Should always be last, with a value one higher than previous key ID.
