...
#define DC_BIND_DEFAULT_ENABLE_X		DC_BIND_POSITIONING_TARGET
#define DC_BIND_DEFAULT_ENABLE_Y		DC_BIND_POSITIONING_TARGET
#define DC_BIND_DEFAULT_ENABLE_Z		DC_BIND_POSITIONING_TARGET
